...
class PackagingTask extends Component {
    constructor(props) {
        super(props)
        this.state = {             
            currentPage: 1,
    ...
    render() {
        ...
        return (
            <div>
                ...
                <br />
                <DetailTask production={currentPosts} handleActionDownload={this.handleActionDownload} linkto={`/production/editpackaging?id=`} />                
                <hr className="style14" />
                <Pagination
