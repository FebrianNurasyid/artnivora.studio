...
class UploadingTask extends Component {
    constructor(props) {
        super(props)
        this.state = {
            currentPage: 1,
    ...
    componentDidMount() {
        this.props.fetchProductions("Uploading");
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <br />  
                <DetailTask production={currentPosts} handleActionDownload={this.handleActionDownload} linkto={`/production/edituploading?id=`} />
                <hr className="style14" />
                <Pagination
